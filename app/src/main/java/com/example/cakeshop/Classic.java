    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, Login.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, Classicrecent.class);
                startActivity(intent);
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, classicpopular.class);
                startActivity(intent);
            }
        });
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, classicseason.class);
                startActivity(intent);
            }
        });
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnpineapple.class);
                startActivity(intent);
            }
        });
        ...
        btn7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnmango.class);
                startActivity(intent);
            }
        });
        ...
        btn9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnstrawberry.class);
                startActivity(intent);
            }
        });
        ...
        btn11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnvanilla.class);
                startActivity(intent);
            }
        });
        ...
        btn13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnpista.class);
                startActivity(intent);
            }
        });
        ...
        btn15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnalmond.class);
                startActivity(intent);
            }
        });
        ...
        btn17.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bngreenapple.class);
                startActivity(intent);
            }
        });
        ...
        btn19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnblueberry.class);
                startActivity(intent);
            }
        });
        ...
        btn21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, bnribbon.class);
                startActivity(intent);
            }
        });
        ...
        btn23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, home.class);
                startActivity(intent);
            }
        });
        ...
        btn24.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, mycart.class);
                startActivity(intent);
            }
        });
        ...
        btn25.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, message.class);
                startActivity(intent);
            }
        });
        ...
        btn26.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Classic.this, profile.class);
                startActivity(intent);
            }
        });
    }
